    ...
    def extract_transportadora_data(self, root, nsNfe):
        ...
        for vol in root.findall("./ns:NFe/ns:infNFe/ns:transp/ns:vol", nsNfe):
            ...
            volData = {
                "Arquivo": chave,
                "idnNF": idnNF,
                "modFrete": modFrete if first_vol else "",
                "CNPJ": transpcNPJ if first_vol else "",
                "CPF": transpcPF if first_vol else "",
                "xNome": xNome if first_vol else "",
                "IE": transpIE if first_vol else "",
                "xEnder": xEnder if first_vol else "",
                "xMun": xMun if first_vol else "",
                "UF": transpUF if first_vol else "",
                "vServ": vServ if first_vol else "",
                "vBCRet": vBCRet if first_vol else "",
                "pICMSRet": pICMSRet if first_vol else "",
                "vICMSRet": vICMSRet if first_vol else "",
                "CFOP": cFOP if first_vol else "",
                "cMunFG": cMunFG if first_vol else "",
                "placa": placa if first_vol else "",
                "Serv_uF": Serv_uF if first_vol else "",
                "RNTC": rNTC if first_vol else "",
                "destino_uF": destino_uF if first_vol else "",
                "vagao": vagao if first_vol else "",
                "balsa": balsa if first_vol else "",
                "qVol": qVol,
                "esp": esp,
                "marca": marca,
                "nVol": nVol,
